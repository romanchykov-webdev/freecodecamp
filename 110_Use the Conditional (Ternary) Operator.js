...
function checkEqual(a, b) {
    // Use the conditional operator to check if a is equal to b
    return a === b ? "Equal" : "Not Equal";
  }
  
  // Test the function
  console.log(checkEqual(1, 2)); // This will print "Not Equal"
  console.log(checkEqual(1, 1)); // This will print "Equal"
  console.log(checkEqual(1, -1)); // This will print "Not Equal"

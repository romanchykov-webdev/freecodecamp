...
const testObj = {
  ...
  // Access the player's name using bracket notation
  const playerNumber = 16; // Set playerNumber to 16
  const player = testObj[playerNumber]; // Use bracket notation to get the player's name
